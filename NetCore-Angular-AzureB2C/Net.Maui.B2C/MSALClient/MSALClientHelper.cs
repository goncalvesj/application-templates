    ...
    public class MSALClientHelper
    {
        ...
        public async Task<IAccount> InitializePublicClientAppAsync()
        {
            ...
            this.PublicClientApplication = this.PublicClientApplicationBuilder
                ...
                // NOTE: To enable a redirect to the system browser using B2C we need to use localhost with a port number.
                // B2C does not support just using localhost as a redirect URI. Needs to be added to the B2C app registration.
        ...
        public async Task<AuthenticationResult> SignInUserInteractivelyAsync(string[] scopes, IAccount existingAccount = null)
        {
            ...
            if (this.PublicClientApplication.IsUserInteractive())
            {
                return await this.PublicClientApplication.AcquireTokenInteractive(scopes)
                    ...
                    // NOTE: Here we are forcing the user to re-authenticate. This is for testing purposes only.
                    // To make the experience more seamless, you can use Prompt.NoPrompt to force a silent re-authentication and let MSAL handle the experience.
